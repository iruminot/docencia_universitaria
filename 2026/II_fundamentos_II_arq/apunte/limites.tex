...
\textbf{¿Qué significa exactamente que $f(x)$ esté cerca de $L$?}. En matemática, \textbf{medir}\footnote{Medir es asignarle un valor numérico a un subconjunto de un espacio para cuantificar su magnitud.} la cercanía de dos números se hace a través de la \textbf{distancia}\footnote{Distancia o métrica es asignarle un valor numérico no negativo a cada par de elementos de un espacio para cuantificar su separación.} entre ellos, que se define como el \textbf{valor absoluto de su diferencia}.
